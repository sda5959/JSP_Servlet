...
<!-- 
	import 태그 : 외부의 문서를 현재문서에 포함시킨다. include 지시어처럼
		...
		같은 기능으로 콤파일이 먼저 진행된 후 결과를 포함시키게 된다.
 ...
 -->
	...
	<!-- 
	 ...
	 <!-- 
	 	...
	 	경로도 수정되야 하므로 이를 최소화할수 있도록 개방하는것이 좋다.
	 ...
	 <div>
	 	...
	 	<h5>절대경로 지정</h5>
	 	<img src="MustHaveJSP/11JSTL/images/Error.jpg" width="150" height="80"/>
	 	<h5>절대경로 지정</h5>
	 	<img src="<%=request.getContextPath() %>/images/Error.jpg" width="150" height="80"/>
	 </div>
	 
	 <!--  앞에서 선언한 import태그의 var속성의 변수를 통해 문서의 내용 출력 -->
	<h4>다른 문서 삽입하기</h4>
	${contents }
