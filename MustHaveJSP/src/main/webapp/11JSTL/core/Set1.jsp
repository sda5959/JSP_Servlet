...
<body>
<!-- 
	set태그 : 변수를 선언할 때 사용한다.JSP의 setAAtribute()와 동일한 
 ...
 -->
	...
	<!-- 
	 ...
	 -->
	 <!--  자바빈즈 생성시 생성자를 통해 초기값을 설정하고 ,
	 	request영역에 변수를 저장한다. -->
	<c:set var="personVar1" value='<%= new Person("박문수", 50) %>'
		scope="request" />
		<!-- request영역에 저장된 자바빈즈의 getter()를 통해 
			멤버변수의 값을 출력한다. -->
	<ul>
	...
	<!--  자바빈즈에 정의한 setter()를 통해 초기화 한다. 값을 나중에 
	설정하려면 target과 property속성을 사용합니다. target에는 변수를
	property에는 멤버변수명을 지정한다. -->
