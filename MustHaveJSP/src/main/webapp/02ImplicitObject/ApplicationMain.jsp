...
<body>
	...
	<!-- 
		이클립스에서는 우리가 직접 작성한 파일을 실행하지 않고 .metadata디렉토리 하위에
		프로젝트와 동일한 톰켓환경을 만들어서 복사본 파일을 실행한다 따라서 아래의 물리적경로는
	...
	<%!
	/*
		선언부에서는 내장객체를 바로 사양하는건 불가능하다.
		내장객체는 _jspService()메서드내에서 생성된 지역변수이므로
		더 넓은 지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다.
	*/
	public String useImplicitObject() {
	    /*
	    	방법1 : getServletContext() 메서드를 통해 선언부에서 application내장객체를
	    	얻어올 수 있다.
	    */
