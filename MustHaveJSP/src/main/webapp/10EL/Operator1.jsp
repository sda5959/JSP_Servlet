...
<body>
	...
	<!-- 
		톰켓8.0부터는 EL에서 변수할당을 할수 있다. 하지만 변수할당과 동시에
		출력되므로, 할당문 뒤에 ;''를 붙여줘야 출력되지 않는다.
		즉, EL에서 변수할당은 많이사용되지 않는다.
	 -->
	...
	num1 - num2 : ${ num1 - num2 } <br />
	num1 * num2 : ${ num1 * num2 } <br />
	<!--  나눗셈에서 /와 div연산자를 사용할 수 있다. 또한 자동형변환이 
	...
	<!--  EL에서는 +는 덧셈연산만 가능, 문자열의 연결에는 사용되지않음. -->
	<h3>+ 연산자는 덧셈만 가능</h3>
	num1 + "34" : ${ num1 + "34" }<br />
	<!--  하지만 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산이 불가능
	하므로 예외가 발생한다. -->
	num2 + "이십" : \${ num2 + "이십" }<br />
	"삼십" + "사십" : \${ "삼십" + "사십" }
