...
<jsp:setProperty name="user" property="userExtraAddress" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	 <%
	 	...
	 	if (user.getUserID() == null || user.getUserPassword() == null || user.getUserName() == null || user.getUserGender() == null || user.getUserPhoneNumber() == null || user.getUserEmail() == null){
	 		PrintWriter script = response.getWriter();
	 		script.println("<script>");
